    ...
    public partial class frmAccountSetup : BaseForm,IToolBar
    {
        ...
        public bool SAVE()
        {
            ...
            if (ValidatingControls() == true)
            {
                ...
                ds = cls.SaveRecord(strButtonState, null, General.strTableName, PnlMain, strTransType, strCondition, "BankCash=" + strBankCash + ";BranchCode=" + General.strBranchCode + ";UserId=" + General.strUserId + "");

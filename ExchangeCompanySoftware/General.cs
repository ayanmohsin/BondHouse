    ...
    class General
    {
        ...
        public DataSet DeleteRecord(string[] strTableName,string strCondition)
        {
            ...
            catch (Exception)
            {
                ...
                MessageBox.Show("Error Deleting Record", "", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return null;
            }
        ...
        //    {
        //        dsMain = objGetData.InsertMasterRecord(ref strError ,ds, strTransType, strTableName,strCondition,);
        //    }

...
namespace ExchangeCompanySoftware
{
    public partial class frmTransDemandDraft : BaseForm,IToolBar
    {
        ...
        public bool QUERY()
        {
            ...
            string strQuery;
            strQuery = "Select * from EX_TransDemandDraft " + General.strStatusCondition + " and BranchCode = '" + General.strBranchCode + "' AND Posted = 'false'";
        ...
        {
            cls = new General();
            General.strTableName[0]= "EX_TransDemandDraft";

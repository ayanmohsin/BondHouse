...
{
    public partial class frmBankAccounts : BaseForm,IToolBar
    {
        ...
        public bool HISTORY()
        {
            ...
            public bool SAVE()
            {
                ...
                {
                    strCondition = "Where BankCode = '" + ditxtItemCode.Text + "'";
            ...
            public bool QUERY()
            {
                ...
                string strQuery;
                strQuery = "Select * from EX_SetupBankAccount " + General.strStatusCondition + "";
        ...
        {
            General.strTableName[0]= "EX_SetupBankAccount";
            General.strPKColumn = "BankCode";
        ...
        private void ditxtItemName_TextChanged(object sender, EventArgs e)
        {

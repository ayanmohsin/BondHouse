...
{
    public partial class frmCategory : BaseForm, IToolBar
    {
        ...
        public bool HISTORY()
        {
            ...
            public bool QUERY()
            {
                ...
                string strQuery;
                strQuery = "Select * from EX_SetupCategory " + General.strStatusCondition + "";
        ...
        {
            General.strTableName[0] = "EX_SetupCategory";

...
namespace ExchangeCompanySoftware
{
    public partial class frmTransProcess : BaseForm,IToolBar
    {
        ...
        private bool IndexSales()
        {
            ...
            {
                strQuery = "Delete From EX_PrsTransactions Where VoucherNo = '" + dtbTT.Rows[i]["Code"].ToString() + "' and BranchCode = '" + General.strBranchCode + "'";
                 cls.ExecuteDML(strQuery);
        ...
        //    if (Checkstock() == true)
                ...
                ds = cls.GetDataSet(strQuery1 + ";" + strQuery);
                dtb = ds.Tables[0];
                dtbRev = ds.Tables[2];
                if (dtb.Rows.Count != 0)
                {

    ...
    public partial class frmTCSetup : BaseForm,IToolBar
    {
        ...
        public bool SAVE()
        {
            ...
            if (ValidatingControls() == true)
            {
                ...
                ds = cls.SaveRecord(strButtonState, null, strTableName, PnlMain, strTransType, strCondition, "UserID=" + General.strUserId + ";Denomination="+ dicboDenomination.SelectedText +"");
        ...
        public bool QUERY()
        {
            ...
            string strQuery;
            strQuery = "Select * from EX_TCSetup";
